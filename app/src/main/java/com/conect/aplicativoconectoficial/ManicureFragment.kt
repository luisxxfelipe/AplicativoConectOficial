...
class ManicureFragment: Fragment(R.layout.fragment_manicure) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoriaAdapter.items = arrayListOf(
            Categorias(1, "https://www.dlf.pt/dfpng/maxpng/211-2114752_bigotes-png.png", "Mãos", 0xFFB6D048),
            Categorias(2, "https://www.dlf.pt/dfpng/maxpng/27-273960_shivaji-maharaj-png.png", "Pés", 0xFFE91D2D),
